...
- **Intrinsic Properties:** related to atom bonding (The material itself)
	...
	- [[Technology of Metallic Materials/Elasticity]]
	- [[Technology of Metallic Materials/Thermal Expansion]] Coefficient
...
![[Technology of Metallic Materials/attachments/Pasted image 20260128161405.png]]

> [!note]
> Despite the name "octahedral", the primitive structure has 6 atoms, not 8. (It has 8 faces)

![[Technology of Metallic Materials/attachments/Pasted image 20260128161545.png]]
...
Each structure (FCC, BCC, HCP) has characteristic slip systems. The ductility of the material depends on the number of **independent** slip systems available. According to the (Taylor) **[[Technology of Metallic Materials/Plastic Deformation#Taylor-Von Mises Criterion\|Von Mises Criterion]]**, a polycrystal requires at least **5 independent slip systems** to deform arbitrarily without cracking. FCC metals (12 systems) satisfy this and are ductile; HCP metals (often <5 systems) do not, and are often brittle unless they deform by twinning.

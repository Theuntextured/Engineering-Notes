...
| **M.P. (°C)**               | **1538**                              | **660**                              | **1085**                        |
| **Density ($kg~m^{-3}$)**   | **7870**                              | **2700**                             | **8960**                        |
| **Allotropy**               | **Yes** (BCC $\alpha$, FCC $\gamma$)  | **No** (Always FCC)                  | **No** (Always FCC)             |
...
| **Compounds**               | Carbides ($Fe_3C$), Oxides            | Alumina ($Al_2O_3$), Intermetallics  | Oxides ($CuO$), Sulfides        |
...
| **M.P. (°C)**               | **1455**                              | **1668**                                 | **650**                                   |
| **Density ($kg~m^{-3}$)**   | **8908** (Heavy)                      | **4506** (Light-ish)                     | **1738** (Very Light)                     |
| **Allotropy**               | **No** (FCC)                          | **Yes** (HCP $\alpha$ $\to$ BCC $\beta$) | **No** (HCP)                              |
...
| **Compounds**               | Intermetallics ($\gamma'$ $Ni_3Al$)   | Oxides ($TiO_2$), Carbides               | Oxides ($MgO$), Hydrides                  |

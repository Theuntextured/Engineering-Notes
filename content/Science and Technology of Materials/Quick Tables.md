...
| Flexural Strength $\sigma_f$ | The maximum stress a material can withstand under a bending load before it yields or ruptures, representing its ability to resist deformation when subjected to a transverse force.                                                                       |
...
| Material Type | Density Min ($gm/cm^3$) | Density Max ($gm/cm^3$) | $k / Wm^{-1}K^{-1}$ | $\alpha/10^{-6}K^{-1}$ |
| :-----------: | :---------------------: | :---------------------: | ------------------- | ---------------------- |
...
$$
E_{\text{Covalent Solids}}>E_{\text{Crystalline Oxides}}>E_{\text{Glasses}}>E_{\text{Metals}}\gg E_{\text{Polymers}}
$$

$$
k_{air}\ll k_{\text{Polymers}}\ll k_{\text{Glass}}<k_{\text{Ceramics}}<k_{\text{Metals}}
$$
